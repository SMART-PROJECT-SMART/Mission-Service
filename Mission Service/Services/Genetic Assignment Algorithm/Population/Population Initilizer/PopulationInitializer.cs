...
namespace Mission_Service.Services.Genetic_Assignment_Algorithm.Population.Population_Initilizer
{
    public class PopulationInitializer : IPopulationInitializer
    {
        ...
        public IEnumerable<AssignmentChromosome> CreateInitialPopulation(IEnumerable<Mission> missions, IEnumerable<UAV> uavs)
        {
            ...
            {
                AssignmentChromosome randomAssignmentChromosome = CreateRandomAssignmentChromosome(missions,uavs);
        ...
        public AssignmentChromosome CreateRandomAssignmentChromosome(IEnumerable<Mission> missions,IEnumerable<UAV> uavs)
        {
