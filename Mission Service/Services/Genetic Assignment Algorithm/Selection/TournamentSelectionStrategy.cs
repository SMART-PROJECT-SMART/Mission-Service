...
namespace Mission_Service.Services.Genetic_Assignment_Algorithm.Selection
{
    public class TournamentSelectionStrategy : ISelectionStrategy
    {
        ...
        public AssignmentChromosome selectParentChromosome(IEnumerable<AssignmentChromosome> population)
        {
            ...
            for (int contestantIndex = 0; contestantIndex < _algorithmConfiguration.TournamentSize; contestantIndex++)
            {
