        ...
        public static double NormalizeTelemetryValue(this TelemetryFields field, double value)
        {
            return field switch
            {
                ...
                TelemetryFields.CurrentSpeedKmph => Math.Min(
                    value / MissionServiceConstants.TelemetryNormalization.MAX_SPEED_KMPH,
                    MissionServiceConstants.TelemetryNormalization.MIN_NORMALIZED_VALUE
                ),
                TelemetryFields.Altitude => Math.Min(
                    value / MissionServiceConstants.TelemetryNormalization.MAX_ALTITUDE,
                    MissionServiceConstants.TelemetryNormalization.MIN_NORMALIZED_VALUE
                ),
                TelemetryFields.CruiseAltitude => Math.Min(
                    value / MissionServiceConstants.TelemetryNormalization.MAX_ALTITUDE,
                    MissionServiceConstants.TelemetryNormalization.MIN_NORMALIZED_VALUE
                ),
                TelemetryFields.SignalStrength => (
                    value + MissionServiceConstants.TelemetryNormalization.SIGNAL_STRENGTH_OFFSET
                ) / MissionServiceConstants.TelemetryNormalization.SIGNAL_STRENGTH_RANGE,
                TelemetryFields.DataStorageUsedGB => MissionServiceConstants
                ...
                TelemetryFields.EngineDegrees => MissionServiceConstants
                    .TelemetryNormalization
                    .MIN_NORMALIZED_VALUE
                    - Math.Min(
                ...
                TelemetryFields.PitchDeg => (
                    value + MissionServiceConstants.TelemetryNormalization.PITCH_ROLL_OFFSET
                ) / MissionServiceConstants.TelemetryNormalization.PITCH_ROLL_RANGE,
                TelemetryFields.RollDeg => (
                    value + MissionServiceConstants.TelemetryNormalization.PITCH_ROLL_OFFSET
                ) / MissionServiceConstants.TelemetryNormalization.PITCH_ROLL_RANGE,
                TelemetryFields.DragCoefficient => MissionServiceConstants
                    .TelemetryNormalization
                    .MIN_NORMALIZED_VALUE
                    - Math.Min(
                        value / MissionServiceConstants.TelemetryNormalization.MAX_DRAG_COEFFICIENT,
                        MissionServiceConstants.TelemetryNormalization.MIN_NORMALIZED_VALUE
                    ),
                TelemetryFields.LiftCoefficient => Math.Min(
                    value / MissionServiceConstants.TelemetryNormalization.MAX_LIFT_COEFFICIENT,
                    MissionServiceConstants.TelemetryNormalization.MIN_NORMALIZED_VALUE
                ),
